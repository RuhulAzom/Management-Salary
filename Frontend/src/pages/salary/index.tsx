  ...
  const getEmployeeSalaryById = async (id: string, page: number) => {
    ...
    try {
      const res = await axios.get(
        `${API_URL}/employee/salary/${id}?page=${page}`,
        {
          headers: {
            Authorization: `bearer ${token}`,
          },
    ...
    <div className="p-0 bg-body">
      ...
      <div className="rounded-sm bg-white">
        <div className="border-b py-4 px-[1.5rem] w-full flex justify-between items-center">
          <div className="flex">
            <div className="pr-4">
              <h3 className="font-medium text-black dark:text-white">Salary</h3>
            </div>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr>
                    ...
                    <th className="font-[500] p-[.5rem] text-start">Date</th>
                    <th className="font-[500] p-[.5rem] text-start">Member</th>
                    <th className="font-[500] p-[.5rem] text-start">
                      Attendance
                    </th>
                    <th className="font-[500] p-[.5rem] text-start">Permit</th>
                    <th className="font-[500] p-[.5rem] text-start">
                      Overtime
                    </th>
                    <th className="font-[500] p-[.5rem] text-start">
                ...
                <tbody>
                  {employeeSalaryData.map((item, index) => (
                    <tr>
                      ...
                      <td className="p-[.5rem] text-start">{item.member}</td>
                      <td className="p-[.5rem] text-start">
                        {item.attendance}
                      </td>
                      <td className="p-[.5rem] text-start">{item.permit}</td>
                      <td className="p-[.5rem] text-start">{item.overtime}</td>
                      <td className="p-[.5rem] text-start">
                        Rp.{" "}
                        {item.salary_per_day.toLocaleString("id-ID", {
                          style: "decimal",
                        })}
                      </td>
                      <td className="p-[.5rem] text-start">
                        Rp.{" "}
                        {item.total_salary.toLocaleString("id-ID", {
                          style: "decimal",
                        })}
                      </td>
                      <td className="p-[.5rem] text-start">
                        <div className="w-full flex justify-center items-center gap-[.5rem]">
                          ...
                          <button
                            className="bg-green-100 text-green-600 py-[.5rem] px-[1rem] font-[600] rounded-[.7rem] hover:bg-green-200 active:bg-green-100 text-[.8rem]"
                            onClick={() => {
                              setPrintData({
                                ...item,
                              });
      ...
      {printData && (
        <div className="w-full flex flex-col items-center mt-[5rem] pb-[5rem]">
          ...
          <div id="printSalary" className="w-full max-w-[800px]">
            <div
              id="contentSalary"
              className="rounded-sm bg-white shadow-xl w-full"
            >
              ...
              <div className="p-[2rem] flex flex-col gap-[1rem]">
                ...
                <div id="detail" className="flex flex-col">
                  <div className="bg-main-hover px-[1rem] py-[.5rem] text-white font-[600]">
                    <p>
                      {getDateString(printData.start_date)} -{" "}
                      {getDateString(printData.end_date)}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 border border-b-0 border-main-gray-border">
                    ...
                    >
                      <p>
                        {printData.overtime}x Rp.{" "}
                        {printData.overtime_salary.toLocaleString("id-ID", {
                          style: "decimal",
                        })}
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-3 border border-b-0 border-main-gray-border">
                    ...
                    >
                      <p>
                        {printData.attendance}x Rp.{" "}
                        {printData.salary_per_day.toLocaleString("id-ID", {
                          style: "decimal",
                        })}
                      </p>
                    </div>
                    ...
                    >
                      <p>
                        Rp{" "}
                        {(
                          printData.attendance * printData.salary_per_day
                  ...
                  <div className="grid grid-cols-3 border border-b-0 border-main-gray-border">
                    ...
                    >
                      <p>
                        Rp{" "}
                        {(printData.member * memberSalary).toLocaleString(
                          "id-ID",
                          { style: "decimal" }
                        )}
                      </p>
                  ...
                  <div className="grid grid-cols-3 border-main-gray-border relative">
                    ...
                    >
                      <p className="break-words">
                        {printData.total_salary.toLocaleString("id-ID", {
                          style: "currency",
                          currency: "IDR",
                        })}
                      </p>
              ...
              <div className="border-t border-main-gray-border p-[1rem] text-[1.2rem] font-[500] flex justify-between">
                <p className="sansita text-main-gray-text">
                  Best Market - Nazea Mart
                </p>
                <p className="sansita text-main-gray-text">
                  Jl. Marapalam Indah No. 08, Kubu Marapalam
                </p>
              </div>
            </div>
          </div>
